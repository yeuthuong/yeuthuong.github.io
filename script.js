...
;
 ...
 Play_SVG.click(function(){
    ...
    if ( $(this).hasClass('active') ) {
      ...
      //container shadow
      TweenMax.to(RP_cont, 1.25, {width: 640, height:480, boxShadow: '0.5em 1em 1em 0em rgba(0,2,6,0.08), 1em 2em 4em 0em rgba(0,2,6,0.08), 0em 0em 0em 0em rgba(0,2,6,0.06), 0em 0em 0em -4em rgba(0,2,6,0.12), 0em 0em 2em -4em rgba(0,2,6,0.12)',  ease:Cubic.easeInOut});
      //BTM-bar shadow
